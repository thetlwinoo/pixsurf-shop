...
export const layoutPaths = {
    images: {
        root: IMAGES_ROOT,
        home: IMAGES_ROOT + 'home1/',
        theme: IMAGES_ROOT + 'theme/',
        photos: IMAGES_ROOT + 'photos/',
        caticon: IMAGES_ROOT + 'cat-icon/',
        flag: IMAGES_ROOT + 'flag/',
        previews: IMAGES_ROOT + 'previews/',
        megamenu: IMAGES_ROOT + 'mega-menu/'
    }
};
