...
import { PixsurfSidebarService } from './sidebar.service';
...
@Component({
    selector     : 'pixsurf-sidebar',
    templateUrl  : './sidebar.component.html',
    styleUrls    : ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class PixsurfSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._pixsurfConfigService.config
            ...
            .subscribe((config) => {
                this._pixsurfConfig = config;
            });

        // Register the sidebar
        this._pixsurfSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._pixsurfSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('pixsurf-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('pixsurf-sidebar-overlay-invisible');
        }
