...
@Directive({
    selector: '[pixsurfPerfectScrollbar]'
})
export class PixsurfPerfectScrollbarDirective implements AfterViewInit, OnDestroy
{
     ...
     */
    @Input()
    set pixsurfPerfectScrollbarOptions(value)
    {
        // Merge the options
        this._options = _.merge({}, this._options, value);
    }

    get pixsurfPerfectScrollbarOptions(): any
    {
        // Return the options
    ...
    ngAfterViewInit(): void
    {
        ...
        if ( this.pixsurfPerfectScrollbarOptions.updateOnRouteChange )
        {
            this._router.events
                .pipe(
    ...
    _init(): void
    {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.pixsurfPerfectScrollbarOptions
        });
    }
